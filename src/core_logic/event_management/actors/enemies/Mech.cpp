...
namespace CoreLogic::EventManagement::Actors
{
    ...
    Mech::Mech(Vector2 pa_position, Rectangle pa_hitbox, int pa_objectId, Vector2 pa_objectSize, int pa_objectElevation,
            ...
            Enemy(pa_position, pa_hitbox, pa_objectId, pa_objectSize, pa_objectElevation, pa_objectClockwise, pa_objectStartingDirection, pa_objectTurnCycle, {pa_position.x +24, pa_position.y + 12})
    {
